...
'margin-top:150px;background:#F2F2F2;padding:10px ;color:#000; margin-left:900px; 
...
'><strong>
التعليقات ' ".mysql_num_rows($selectcm)." '</strong></style></span>
...
echo"<tr >
 <td style='border-bottom:1px solid #A4A4A4; padding:5px;'> ".$fetchcm['comment']." </td>
...
#================================#
 if(isset($_POST['addcm'])){
		...
		if(isset($q))
		{
			 echo'<script>alert("تمت اضافة التعليق بنجاح");</script>';
